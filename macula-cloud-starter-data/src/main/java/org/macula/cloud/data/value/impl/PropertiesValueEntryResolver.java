 ...
 */
@Slf4j
public abstract class PropertiesValueEntryResolver implements ValueEntryResolver, ApplicationContextAware, Ordered {
	 ...
	 * 内部解析，由子类完成.
	 */
	protected abstract Serializable resolveInternal(String originValue, SubjectPrincipal userContext);
