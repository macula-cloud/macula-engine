package org.macula.cloud.data.handle;
...
public final class DataHandlerChain {
	 ...
	 * @param pageable 分页信息
	 */
	public Object handle(String origin, SubjectPrincipal userContext, Object dataSource, Pageable pageable) {
	...
	public void addInitialParameter(String key, Object value) {
		if (value instanceof Serializable) {
			initialParams.put(key, (Serializable) value);
		} else {
