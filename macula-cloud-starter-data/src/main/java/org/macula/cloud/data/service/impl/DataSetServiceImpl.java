package org.macula.cloud.data.service.impl;
...
import org.macula.cloud.data.event.DataSetChangedEvent;
import org.macula.cloud.data.event.DataSourceChangedEvent;
import org.macula.cloud.data.loader.dataset.DataSetLoader;
import org.macula.cloud.data.service.DataSetService;
import org.macula.cloud.data.util.QueryReferenceUtils;
...
public class DataSetServiceImpl implements DataSetService, ApplicationListener<ApplicationEvent> {
	...
	public void onApplicationEvent(ApplicationEvent event) {
		...
		// 关联数据变化，清除缓存
		if (event instanceof DataSetChangedEvent || event instanceof DataSourceChangedEvent || event instanceof DataParamChangedEvent) {
			dataSetMap.clear();
		}
	}
}
