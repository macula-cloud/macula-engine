...
public class ColumnMapRowMapper extends org.springframework.jdbc.core.ColumnMapRowMapper {
	...
	public ColumnMapRowMapper(Map<String, Object> map, SubjectPrincipal userContext) {
	...
	public Map<String, Object> mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		for (int i = 1; i <= columnCount; i++) {
			...
			if (obj != null && extractParams.containsKey(labelKeyUpper)) {
				FieldOption option = DataSetUtils.createFieldOption((String) extractParams.get(labelKeyUpper), obj.toString(), null, userContext);
				if (option != null) {
