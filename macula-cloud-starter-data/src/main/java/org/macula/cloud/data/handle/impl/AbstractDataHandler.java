...
import org.macula.cloud.data.handle.DataHandler;
...
public abstract class AbstractDataHandler implements DataHandler {
	...
	@Override
	public final Object handle(Object data, SubjectPrincipal userContext) {
		return handleInternal(data, userContext.addAdditionInfo(getExtractParams()));
	}

	protected abstract Object handleInternal(Object data, SubjectPrincipal userContext);
}
